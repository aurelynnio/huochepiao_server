...
public class VNPayConfig {
    ...
    private String returnUrl = "https://api.vetautet.app/api/payments/vnpay/callback";
    ...
    public static String hmacSHA512(final String key, final String data) {
        try{
            ...
            byte[] hmacBytes = key.getBytes();
            final SecretKeySpec secretKeySpec = new SecretKeySpec(hmacBytes,"HmacSHA512");
